...
export function createProjectsRouter(requireAdmin) {
    ...
    router.put('/admin/projects/by-id/:id', requireAdmin, adminWriteRateLimit, projectsController.updateProject);
    router.delete('/admin/projects/by-id/:id', requireAdmin, adminWriteRateLimit, projectsController.deleteProject);
