...
export function createMediaRouter(requireAdmin) {
    ...
    router.put('/admin/media/by-id/:id', requireAdmin, adminWriteRateLimit, mediaController.updateMedia);
    router.delete('/admin/media/by-id/:id', requireAdmin, adminWriteRateLimit, mediaController.deleteMedia);
